...
//		ExtentTestManager.getTest().log(Status.INFO, "Upload one per time - Step 01: Upload 'Da Lat' file");
...
//
//		ExtentTestManager.getTest().log(Status.INFO, "Upload one per time - Step 03: Click to 'Start' button");
...
//		ExtentTestManager.getTest().log(Status.INFO, "Upload multiple files per time - Step 01: Refresh the page");
...
//		verifyTrue(homePage.isUpLoadedLinkByFileName(dalatFileName));
//
//		ExtentTestManager.getTest().log(Status.INFO, "Upload one per time - Step 08: Verify 'Hue' file link is ready");
...
//		verifyTrue(homePage.isUpLoadedImageByFileName(dalatFileName));
//
//		ExtentTestManager.getTest().log(Status.INFO, "Upload one per time - Step 11: Verify 'Hue' image file is ready");

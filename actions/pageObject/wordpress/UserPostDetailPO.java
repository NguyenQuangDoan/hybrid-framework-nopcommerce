...
public class UserPostDetailPO extends BasePage {
	...
	public boolean isPostDetailInfoDisplayedWithPostTitle(String postTitle) {
	...
	public boolean isPostDetailInfoDisplayedWithPostBody(String postTitle, String postBody) {
	...
	public boolean isPostDetailInfoDisplayedWithAuthorName(String postTitle, String authorName) {
	...
	public boolean isPostDetailInfoDisplayedWithCurrentDay(String postTitle, String currentDay) {
		waitForElementVisible(driver, UserPostDetailPageUI.POST_CURRENT_DATE_TEXT_BY_POST_TITLE, postTitle, currentDay);
		return isElementDisplayed(driver, UserPostDetailPageUI.POST_CURRENT_DATE_TEXT_BY_POST_TITLE, postTitle,
				currentDay);
	}
